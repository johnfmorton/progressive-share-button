export class ProgressiveShareButtonClass extends HTMLElement {
    constructor() {
        ...
        this.iconSize = () => {
            var _a
            const size =
                (_a = this.getAttribute('icon-size')) !== null && _a !== void 0
                    ? _a
                    : ''
            if (_isNumeric(size)) {
                return size + 'px'
...
function _getBoolean(stringValue) {
    ...
    switch (
        (_a =
            stringValue === null || stringValue === void 0
                ? void 0
                : stringValue.toLowerCase()) === null || _a === void 0
            ? void 0
            : _a.trim()
    ) {
        case 'true':
