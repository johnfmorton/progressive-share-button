    ...
    share() {
      ...
      let shareEvent: ProgressiveShareSuccessEvent = new CustomEvent(
        ...
        if (navigator.share) {
            ...
            // fallback for browsers that don't support navigator.share only shown if debug is set to 1
            console.debug('data to be shared', data)
        }
    }
}
...
const iosShareIcon =
    '<svg xmlns="http://www.w3.org/2000/svg" part="shareIcon" viewBox="0 0 84.53 108.43" class="icon"><title>Share icon</title><desc>Square with upward arrow</desc><path d="m76.21,33.15h-23.38v5.28h23.38c1.72,0,3.04,1.32,3.04,2.91v58.77c0,1.58-1.32,2.91-3.04,2.91H8.32c-1.72,0-3.04-1.32-3.04-2.9v-58.64c0-1.58,1.32-2.91,3.04-2.91h20.74v-5.28H8.32c-4.62,0-8.32,3.7-8.32,8.19v58.77c0,4.49,3.7,8.19,8.32,8.19h67.88c4.62,0,8.32-3.7,8.32-8.19v-58.77c0-4.62-3.7-8.32-8.32-8.32h0Z"/><path d="m39.62,8.58v69.21h5.28V8.58l13.6,10.04,3.17-4.23L42.26,0l-19.41,14.4,3.17,4.23,13.6-10.04Z"/></svg>'

const androidShareIcon =
    '<svg part="shareIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 85 99" class="icon"><title>Share icon</title><desc>Circle with smaller circles radiating out</desc><path d="m68.25,65.5c-4.9,0-9.3,2.13-12.36,5.49l-24.05-13.5c1.06-2.19,1.67-4.64,1.67-7.24s-.58-4.91-1.58-7.06l25.06-14.09c2.98,2.72,6.93,4.4,11.27,4.4,9.24,0,16.75-7.51,16.75-16.75S77.49,0,68.25,0s-16.75,7.51-16.75,16.75c0,2.89.73,5.61,2.03,7.98l-24.73,13.91c-3.05-3.16-7.32-5.14-12.04-5.14C7.51,33.5,0,41.01,0,50.25s7.51,16.75,16.75,16.75c4.66,0,8.87-1.91,11.91-4.99l24.22,13.6c-.88,2.04-1.38,4.28-1.38,6.64,0,9.24,7.51,16.75,16.75,16.75s16.75-7.51,16.75-16.75-7.51-16.75-16.75-16.75Zm0-60c6.2,0,11.25,5.05,11.25,11.25s-5.05,11.25-11.25,11.25-11.25-5.05-11.25-11.25,5.05-11.25,11.25-11.25ZM16.75,61.5c-6.2,0-11.25-5.05-11.25-11.25s5.05-11.25,11.25-11.25,11.25,5.05,11.25,11.25-5.05,11.25-11.25,11.25Zm51.5,32c-6.2,0-11.25-5.05-11.25-11.25s5.05-11.25,11.25-11.25,11.25,5.05,11.25,11.25-5.05,11.25-11.25,11.25Z" style="stroke-width:0px;"/></svg>'

const winShareIcon =
    '<svg xmlns="http://www.w3.org/2000/svg" part="shareIcon" viewBox="0 0 110.99 99.32" class="icon"><title>Share icon</title><desc>Square with arrow coming out to the right</desc><polygon points="84.77 99.32 0 99.32 0 27.94 6 27.94 6 93.32 78.77 93.32 78.77 82.95 84.77 82.95 84.77 99.32" style="stroke-width:0px;"/><path d="m73.04,76.88v-20.93c-7.62.28-28.89,2.31-46.16,15.73l-5.47,4.25.64-6.9c4-43.17,39.92-47.46,50.99-47.74V0l37.95,38.49-37.95,38.39Zm.62-49.64c-8.39,0-38.1,2.39-44.67,35.65,21.84-13.77,46.06-13.01,47.17-12.97l2.88.11v12.24l23.52-23.79-23.52-23.86v12.92l-3.23-.24c-.21-.01-.97-.06-2.15-.06Z" style="stroke-width:0px;"/></svg>'
...
const _whichIcon = (osOverride) => {
  let os = osOverride;
  if (osOverride===null || osOverride === 'default') {
      os = _guessOs();
  }
    switch (os) {
        case 'iOS':
...
function _getBoolean(stringValue: string | null) {
    if (!stringValue) {
        return false
    }
