...
${w(this.iconSize())}
  ...
  share() {
    const c = n(this.getAttribute("debug")), e = n(this.getAttribute("smart-share")), o = this.getAttribute("url");
    let s = this.getAttribute("text"), i = this.getAttribute("title"), r = {};
    o && (r.url = o), s && (r.text = s), i && (r.title = i), e && (i && i.slice(-1) !== "." && (i = i + "."), s && s.slice(-1) !== "." && (s = s + "."), r = {
      text: `${i ? i + " " : ""}${s ? s + " " : ""}${o || ""}`
    });
    ...
    navigator.share ? c == 1 ? console.debug("data to be shared", r) : navigator.share(r).then(() => {
